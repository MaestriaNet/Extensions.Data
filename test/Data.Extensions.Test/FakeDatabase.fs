...
let prepareDb() =
    ...
    cmd.CommandText <- "create table temp (IntValue int, IntNull int, NumericValue numeric(10,4), NumericNull numeric(10,4), DateValue Date, DateNull Date, StringValue varchar(20), StringNull varchar(20), StringNumber varchar(20))"
    cmd.ExecuteNonQuery() |> ignore

    cmd.CommandText <- "insert into temp values(@int, null, @numeric, null, @date, null, @string, null, @stringNumber)"
