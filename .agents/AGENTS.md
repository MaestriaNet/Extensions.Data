# Maestria.Extensions.Data Project Rules
...
- Ensure new extension methods follow the existing folder layout in `src/`.
- Ensure new extension methods has unity tests in folder `tests/`.
- Ensure new extension methods has documentation in folder `README.md`.
